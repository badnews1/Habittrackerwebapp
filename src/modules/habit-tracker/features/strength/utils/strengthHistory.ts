 ...
 * 
 * @module modules/habit-tracker/features/strength/utils
 * @created 22 ноября 2025
 */

import { Habit } from '@/modules/habit-tracker/types';
import { getCompletionValueForDate } from '../../habits/utils';
import { EMA_PERIOD } from '@/modules/habit-tracker/shared/constants/strength';
