 ...
 * 
 * Отображает текущую частоту и открывает модальное окно для редактирования.
 * Используется в HabitItem для управления частотой выполнения.
 * 
 * @module modules/habit-tracker/features/habits/components/manage/HabitFrequencySection
