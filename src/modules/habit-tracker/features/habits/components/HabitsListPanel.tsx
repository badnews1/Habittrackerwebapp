 ...
 * 
 * Отображает список привычек слева от календарной сетки.
 * Использует хуки модуля habits для операций и состояния.
 * 
 * @module modules/habit-tracker/features/habits/components/HabitsListPanel
...
import type { Habit, DateConfig } from '../types';
import { useHabitOperations } from '../hooks';
...
export function HabitsListPanel({
  ...
  // Используем хук операций для moveHabit и updateHabit
  const { moveHabit, updateHabit } = useHabitOperations();
