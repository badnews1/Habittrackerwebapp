# 🛠️ Задачи для модуля Habit Tracker

**Дата создания:** 22 ноября 2025  

---

> **Цель:** Пошаговые инструкции для типичных задач при работе с модулем habit-tracker.
...
📁 **Файл:** `/modules/habit-tracker/features/habits/components/manage/ManageHabitsModal.tsx`
...
📁 **Файл:** `/modules/habit-tracker/shared/constants/units.ts`
...
📁 **Файл:** `/shared/utils/text/textUtils.ts` → функция `declineUnit()`
...
📁 **Файл:** `/shared/utils/text/textUtils.ts` → функция `getShortUnit()`
...
📁 **Файл:** `/modules/habit-tracker/features/frequency/types/index.ts`
...
📁 **Файл:** `/modules/habit-tracker/features/frequency/components/FrequencyEditor.tsx`
...
📁 **Файл:** `/modules/habit-tracker/features/habits/utils/habitUtils.ts` → функция `getMonthlyGoalFromFrequency()`
...
📁 **Файл:** `/modules/habit-tracker/features/habits/utils/habitUtils.ts` → функция `formatFrequency()`
...
📁 **Файл:** `/shared/utils/text/declineWords.ts`
...
📁 **Файл:** `/shared/utils/validation/frequencyValidation.ts`
...
📁 **Файл:** `/core/store/slices/categories.ts` → добавь миграцию
...
📁 **Файл:** `/modules/habit-tracker/features/strength/utils/strengthCalculator.ts` → функция `recalculateStrength()`
...
📁 **Файл:** `/modules/habit-tracker/docs/BUSINESS_LOGIC.md`
...
/modules/habit-tracker/features/strength/    # Система EMA
/modules/habit-tracker/features/frequency/   # Система частоты
/modules/habit-tracker/features/categories/  # Категории
```
...
**В этом модуле:**
- `BUSINESS_LOGIC.md` - Подробное описание EMA, типов привычек, частоты

**В корневой документации:**
- `/docs/getting-started/COMMON_TASKS.md` - Общие задачи (Zustand, модалки, UI)
...
- [ ] Обновлены типы TypeScript в `/modules/habit-tracker/types/`?
- [ ] Добавлены комментарии на русском?
- [ ] Обновлена документация `/docs/FileStructure.md`?
