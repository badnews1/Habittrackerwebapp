 ...
 * - Модульные логгеры для группировки
 * - Фильтрацию по модулям (whitelist/blacklist)
 * - Управление через window.__logger в dev режиме
 * - Автоматическое отключение в production (если не передан ?debug=true)
 * 
 * @since 20 ноября 2025
 * @updated 30 ноября 2025 - мигрирован в /shared/lib согласно FSD
 */
