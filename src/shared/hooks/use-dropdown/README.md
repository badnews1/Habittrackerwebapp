...
> **Последнее обновление:** 22 ноября 2025 (клавиатурная навигация стрелками)
...
- ✅ Клавиатурная навигация (используется в Dropdown конструкторе):
  - ArrowUp/ArrowDown для навигации между элементами
...
- Опцион��льный `onClose` для сброса состояния
