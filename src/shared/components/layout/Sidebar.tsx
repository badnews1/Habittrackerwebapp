/**
 * Sidebar - боковая навигационная панель приложения
 * 
 * @description
 * Полноэкранный sidebar с навигацией по секциям приложения.
 * Поддерживает активное состояние, отключенные секции и анимацию открытия/закрытия.
 * 
 * Особенности:
 * - Фиксированная позиция слева
 * - Плавная анимация slide-in/slide-out
 * - Секция Dashboard отдельно от других
 * - Настройки в нижней части
...
import { GoalIcon, BarChart3, Settings, Calendar, LayoutDashboard, Close } from '@/shared/icons';

interface SidebarProps {
  /** Текущая активная секция */
  currentSection: string;
  /** Callback при смене секции */
  onSectionChange: (section: string) => void;
  /** Открыт ли sidebar */
  isOpen: boolean;
  /** Callback закрытия sidebar */
  onClose: () => void;
}
