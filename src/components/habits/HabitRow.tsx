...
import { ICON_MAP, SmallFilledCircle } from '../../constants/icons';
...
export function HabitRow({
  ...
  // Get the icon component from the icon map, default to SmallFilledCircle if no icon is set
  const IconComponent = habit.icon ? ICON_MAP[habit.icon] : SmallFilledCircle;

  const [isModalOpen, setIsModalOpen] = useState(false);

  // Generate monthYearKey from selectedMonth and selectedYear
