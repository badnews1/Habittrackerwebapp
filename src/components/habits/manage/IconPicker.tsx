...
import { ICON_MAP, ICON_OPTIONS, SmallFilledCircle, ICONS_PER_PAGE } from '../../../constants/icons';
...
/**
 * Пикер иконок с кнопкой и выпадающим списком
 * 
 ...
 * - Внутреннее: просто передайте selectedIcon и onSelectIcon
 * - Внешнее: также передайте isOpen, onToggle для полного контроля
 * 
