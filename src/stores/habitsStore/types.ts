 ...
 * 
 * @module stores/habitsStore/types
 */

import { Habit, HabitData, HabitType, FrequencyConfig, Reminder } from '../../types/habit';
...
export interface HabitsState extends AddHabitFormActions {
  ...
  // ==================== МОДАЛЬНЫЕ ОКНА ====================
  /** ID привычки для диалога удаления */
  ...
  /** Открыть диалог удаления привычки */
  openDeleteDialog: (habitId: string) => void;
