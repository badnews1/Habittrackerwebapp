...
**Примеры в коде:**
- `/features/habits/components/add-habit-modal/steps/HabitBasicInfoStep.tsx` - поле названия привычки
- `/features/habits/components/add-habit-modal/steps/HabitMeasurableStep.tsx` - поле цели
- `/features/habits/components/HabitMeasurableSettingsSection.tsx` - редактирование цели
...
**Примеры в коде:**
- `/features/habits/components/HabitNameEditor.tsx` - inline редактор названия
- `/features/categories/components/CategoryPicker.tsx` - добавление новой категории
...
**Примеры в коде:**
- `/features/habits/components/NumericInputModal.tsx` - ввод значения измеримой привычки
...
Если существующие варианты не подходят, создай новый в `/shared/constants/styles.ts`:
