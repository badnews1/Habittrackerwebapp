...
// 3. Наши компоненты (Feature-Based)
import { HabitRow } from './modules/habit-tracker/features/habits/components/HabitRow';
import { AddHabitModal } from './components/modals/AddHabitModal';

// 4. Типы
import type { Habit } from './modules/habit-tracker/types';
import type { Category } from './modules/habit-tracker/types';
...
import { formatDate, getDaysInMonth } from './shared/utils/date/dateUtils';
import { DEFAULT_COLOR, MAX_NAME_LENGTH } from './shared/constants/validation';
