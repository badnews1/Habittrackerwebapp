...
Логгер позволяет фильтровать логи по модулям, что упрощает отладку и анализ конкретных частей приложения.
...
// Показать только логи модуля STRENGTH
__logger.showOnly('STRENGTH')

// Показать логи нескольких модулей
...
Детальное руководство по фильтрации логов см. в **[`/docs/LOGGER_MODULE_FILTERING.md`](/docs/LOGGER_MODULE_FILTERING.md)**:

- Белый список (`showOnly`) и чёрный список (`hide`)
- Список всех доступных модулей
- Проверка текущего статуса фильтра
- Практические сценарии использования
- Сочетание с фильтрацией по уровням
