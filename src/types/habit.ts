/**
 * Централизованные типы для системы привычек
 * 
 * Этот файл содержит все интерфейсы и типы, связанные с привычками.
 * Используется во всех компонентах приложения для обеспечения единообразия типов.
 * 
 * Последнее обновление: 20 ноября 2025 - добавлен FrequencyType для унификации
 */
...
export interface HabitData {
  ...
  targetValue?: number;
  targetType?: 'min' | 'max';
  reminders?: Reminder[]; // ← Добавлено: напоминания для привычки
}
